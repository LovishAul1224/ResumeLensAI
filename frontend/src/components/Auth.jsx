    ...
    >
      ...
      >
        <motion.div
          ...
          style={{ display: "flex", justifyContent: "flex-end", marginBottom: "48px" }}
        >
          <Logo size={30} />
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            {!isSignup && (
              ...
              >
                ...
                <span style={{ cursor: "pointer", color: "#999" }}>Forgot password</span>
              </div>
            )}
          ...
          <div style={{ textAlign: "center", fontSize: "12px", color: "#999", marginTop: "26px" }}>
